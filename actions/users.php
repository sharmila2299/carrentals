...
$phonenumber   = isset($contactNumber) ? $contactNumber :'';
$hidrand        = isset($hidrand) ? $hidrand : '';
...
// print_r($_POST);
// exit;
     $user_Qry = "UPDATE ".$tableName." SET  NAME = '".$name."', PHONE_NUMBER = '".$phonenumber."' WHERE RANDOM_ID = '".$hidrand."'";
//    exit;
    $user_Data = $crud->execute($user_Qry);
